...
/*
void tpcc_txn_man::pack(r_query * query, void ** data, int * sizes, int * num) {
...
// TODO: replace with actual data unpacking
void tpcc_txn_man::unpack(r_query * query, char * data) {
	tpcc_r_query * m_query = (tpcc_r_query *) query;
